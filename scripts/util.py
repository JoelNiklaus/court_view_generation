def get_batch_size(model_type, gpu_memory, seq_length):
    batch_sizes = {
        'mgpt': {
            ...
            80: {512: 8, 1024: 6, 2048: 2, 3072: 1, 4096: 0},  # tested 1024 and 2048
        },
        'mt5-small': {
            ...
            80: {512: 16, 1024: 12, 2048: 4, 3072: 2, 4096: 1},# tested 1024 and 2048
            },
        'mt5-base': {
            24: {512: 2, 1024: 1, 2048: 1, 3072: 1, 4096: 1},  # only tested with 512 seq length
            48: {512: 4, 1024: 2, 2048: 1, 3072: 1, 4096: 0},  # never tested
            80: {512: 8, 1024: 6, 2048: 2, 3072: 1, 4096: 0},  # tested 1024 and 2048
            },
        'mt5-large': {
            24: {512: 0, 1024: 0, 2048: 0, 3072: 0, 4096: 0},  # tested
            48: {512: 1, 1024: 1, 2048: 1, 3072: 1, 4096: 1},  # never tested
            80: {512: 4, 1024: 2, 2048: 1, 3072: 1, 4096: 1},  # tested 1024 and 2048
            },
        'mt5-xl': {
            24: {512: 0, 1024: 0, 2048: 0, 3072: 0, 4096: 0},
            48: {512: 1, 1024: 1, 2048: 1, 3072: 1, 4096: 1},  # never tested
